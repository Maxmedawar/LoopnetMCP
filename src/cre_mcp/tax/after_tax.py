...
def after_tax_returns(
    ...
    return AfterTaxResult(
        ...
        depreciation_annual=depreciation[0].total_depreciation,
        ...
        recapture_1250=round(unrecaptured_1250_tax, 2),
        ...
        pre_tax_irr=round(pre_tax_irr, 6) if pre_tax_irr is not None else None,
        after_tax_irr=round(after_tax_irr, 6) if after_tax_irr is not None else None,
